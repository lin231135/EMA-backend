...
import paymentHistoryRoutes from './app/payment.history.routes.js';
...
router.use('/', paymentHistoryRoutes); // /api/parent/payments/history & /api/student/payments/history
